        ...
        <?php foreach ( $kale_posts_slider as $post ) { 
            ...
            <div class="item">
                ...
                <div class="caption">
                    ...
                    <p class="read-more"><a href="<?php the_permalink(); ?>"><?php printf( _nx('%1$s Kommentar', '%1$s Kommentare', get_comments_number(), 'comments title', 'kale' ), number_format_i18n( get_comments_number() ) ); ?></a></p>
                </div>
            </div>
            <?php }
        } wp_reset_postdata(); ?>
